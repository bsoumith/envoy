...
void configureBuilder(
    ...
    jboolean enable_drain_post_dns_refresh, jboolean enable_http3, jboolean enable_scone,
    jboolean enable_early_data, jstring http3_connection_options,
...
extern "C" JNIEXPORT jlong JNICALL Java_io_envoyproxy_envoymobile_engine_JniLibrary_createBootstrap(
  ...
  configureBuilder(
      ...
      enable_drain_post_dns_refresh, enable_http3, enable_scone, enable_early_data,
